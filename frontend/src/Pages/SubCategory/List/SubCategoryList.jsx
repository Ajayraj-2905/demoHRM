...
const SubCategoryList = () => {
    ...
    const filteredData = data.filter(item => {
        ...
        const matchesSelect = selectedCategory.length === 0 ||
    ...
    return (
        <div className='h-full bg-white p-5 rounded-md shadow-lg'>
            <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-2'>
                <h1 className='text-xl font-semibold'>Sub-Category List</h1>
                <div className='flex justify-center items-center gap-4'>
                    ...
                    <Link to='/subCategory' className='flex-1 px-4 py-2 text-center bg-customYellow-default text-white rounded'>Create Sub Category</Link>
                </div>
            </div>
