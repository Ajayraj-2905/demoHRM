...
const CategoryList = () => {
    ...
    useEffect(() => {
        fetchData()
        console.log('Category list running')
    }, [])
        ...
        <div className='h-full bg-white p-5 rounded-md shadow-lg'>
            <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-2'>
                ...
                <div className='flex justify-center items-center gap-4'>
                    ...
                    <Link to='/category' className='flex-1 px-4 py-2 text-center bg-customYellow-default text-white rounded'>Create Category</Link>
                </div>
            </div>
